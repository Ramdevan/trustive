        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-accent text-black rounded-xl text-xs font-bold uppercase tracking-widest hover:scale-[1.05] active:scale-95 transition-all shadow-lg shadow-accent/20"
                >
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-sidebar border border-white/5 rounded-xl pl-11 pr-4 py-3 text-white text-sm focus:border-accent outline-none transition-colors"
                />
            </div>

            {/* Sections Grid */}
            {filteredSections.length === 0 ? (
                <div className="bg-sidebar rounded-[32px] border border-white/5 p-16 text-center">
                    <div className="w-20 h-20 bg-white/5 rounded-3xl flex items-center justify-center mx-auto mb-6">
                        <FileText className="w-10 h-10 text-zinc-600" />
                    </div>
                    <h3 className="text-xl font-bold text-white mb-2">No Sections Found</h3>
                    ...
                    {!searchQuery && (
                        <button
                            onClick={openCreateModal}
                            className="inline-flex items-center gap-2 px-8 py-3 bg-accent text-black rounded-xl text-xs font-bold uppercase tracking-widest hover:scale-[1.05] active:scale-95 transition-all shadow-lg shadow-accent/20"
                        >
                            <Plus className="w-4 h-4" />
                            Create Section
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {filteredSections.map((section) => (
                        <div
                            key={section.id}
                            className={cn(
                                "bg-sidebar rounded-[24px] border overflow-hidden transition-all hover:shadow-xl hover:shadow-accent/5 group",
                                section.is_active ? "border-white/5" : "border-red-500/20 opacity-60"
                            )}
                        >
                            {/* Image Preview */}
                            <div className="relative h-48 bg-black/40 overflow-hidden">
                                ...
                                <div className="absolute top-3 left-3">
                                    <span className={cn(
                                        ...
                                        <span className={cn("w-1.5 h-1.5 rounded-full", section.is_active ? "bg-green-400" : "bg-red-400")} />
                                ...
                                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                                    <button
                                        ...
                                        className="p-3 bg-accent rounded-xl text-black hover:scale-110 transition-transform"
                                        title="Edit"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="p-3 bg-white/10 rounded-xl text-white hover:scale-110 transition-transform"
                                        title="Preview"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="p-3 bg-red-500/20 rounded-xl text-red-400 hover:scale-110 transition-transform"
                                        title="Delete"
                                    >
                            ...
                            <div className="p-5 space-y-3">
                                <div>
                                    <p className="text-[10px] font-black text-accent uppercase tracking-widest mb-1">{section.section_key}</p>
                                    <h3 className="text-white font-bold text-sm truncate">{section.title || "Untitled"}</h3>
                                    {section.subtitle && (
                                        <p className="text-zinc-400 text-xs mt-0.5 truncate">{section.subtitle}</p>
                                    )}
                                </div>
                                {section.description && (
                                    <p className="text-zinc-500 text-xs line-clamp-2 leading-relaxed">{section.description}</p>
                                )}
                                {section.button_text && (
            ...
            {previewSection && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={() => setPreviewSection(null)} />
                    <div className="relative bg-sidebar border border-white/10 rounded-[32px] w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl shadow-black/50 flex flex-col">
                        {/* Preview Header */}
                        <div className="shrink-0 bg-sidebar border-b border-white/5 px-8 py-6 flex items-center justify-between rounded-t-[32px]">
                            <div>
                                <h2 className="text-xl font-bold text-white flex items-center gap-2">
                                    <Eye className="w-5 h-5 text-accent" />
                                    Section Preview
                                </h2>
                                <p className="text-accent text-xs font-mono mt-1">{previewSection.section_key}</p>
                            </div>
                            <button
                        ...
                        {previewSection.image_url && (
                            <div className="shrink-0 border-b border-white/5 py-6 flex justify-center bg-black/20">
                                <img
                                    src={`${API_BASE}${previewSection.image_url}`}
                                    alt={previewSection.title || "Preview"}
                                    className="w-48 h-48 rounded-full object-cover border-4 border-accent/30 shadow-xl shadow-accent/10"
                                />
                            </div>
                        )}
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-6">
                            ...
                            {previewSection.title && (
                                <h3 className="text-2xl font-bold text-white">{previewSection.title}</h3>
                            )}
                            {previewSection.subtitle && (
                                <p className="text-zinc-400 text-sm -mt-3">{previewSection.subtitle}</p>
                            )}
                            ...
                            {(previewSection.button_text || previewSection.button_link) && (
                                <div className="pt-2 space-y-2">
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 px-6 py-3 bg-accent text-black rounded-xl text-xs font-bold uppercase tracking-widest hover:scale-[1.05] active:scale-95 transition-all shadow-lg shadow-accent/20"
                                    >
                                        <LinkIcon className="w-3.5 h-3.5" />
                                        {previewSection.button_text || "Visit Link"}
                                    </a>
                                    {previewSection.button_link && (
                                        <p className="text-zinc-600 text-[10px] font-mono truncate px-1">{previewSection.button_link}</p>
                                    )}
                                </div>
                            )}
                            ...
                            <div className="pt-4 border-t border-white/5 flex items-center gap-4 text-xs text-zinc-500">
                                <span className={cn(
                                    ...
                                    <span className={cn("w-1.5 h-1.5 rounded-full", previewSection.is_active ? "bg-green-400" : "bg-red-400")} />
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-sidebar border border-white/10 rounded-[32px] w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl shadow-black/50 custom-scrollbar">
                        {/* Modal Header */}
                        <div className="sticky top-0 z-10 bg-sidebar border-b border-white/5 px-8 py-6 flex items-center justify-between rounded-t-[32px]">
                            <div>
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/40 border border-white/5 rounded-xl px-4 py-3 text-white focus:border-accent outline-none font-mono text-sm"
                                />
                                <p className="text-zinc-600 text-[10px] px-1">Unique identifier for this section. Only lowercase letters, numbers, underscores.</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-black/40 border border-white/5 rounded-xl px-4 py-3 text-white focus:border-accent outline-none text-sm"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-3">
                                ...
                                {form.descriptions.map((para, index) => (
                                    <div key={index} className="relative group/para">
                                        <div className="flex items-start gap-2">
                                            <span className="text-[10px] text-zinc-600 font-bold mt-3.5 min-w-[20px]">P{index + 1}</span>
                                            <textarea
                                                value={para}
                                                onChange={(e) => updateParagraph(index, e.target.value)}
                                                placeholder={`Paragraph ${index + 1}...`}
                                                rows={3}
                                                className="flex-1 bg-black/40 border border-white/5 rounded-xl px-4 py-3 text-white focus:border-accent outline-none text-sm resize-none"
                                            />
                                            {form.descriptions.length > 1 && (
                                                <button
                                                    type="button"
                                                    onClick={() => removeParagraph(index)}
                                                    className="p-2 mt-1 text-zinc-600 hover:text-red-400 transition-colors"
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2.5 bg-white/5 border border-white/5 rounded-xl text-zinc-400 hover:text-accent hover:border-accent/20 transition-all text-xs font-bold"
                                >
                                    ...
                                    {imagePreview ? (
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                className="absolute -top-2 -right-2 p-1.5 bg-red-500 rounded-full text-white hover:scale-110 transition-transform"
                                            >
                                                <X className="w-3 h-3" />
                                            </button>
                                        </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        "w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border font-bold text-sm transition-all",
                                        form.is_active
                        ...
                        {/* Modal Footer */}
                        <div className="sticky bottom-0 bg-sidebar border-t border-white/5 px-8 py-5 flex items-center justify-end gap-4 rounded-b-[32px]">
                            <button
                                onClick={closeModal}
