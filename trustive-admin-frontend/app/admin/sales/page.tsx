...
export default function SalesManagement() {
    ...
    const tokenAddress = (settingsData?.settings?.contract_address || "0xe12F60d7c0bc493b033c789Aa533E772541041eA") as `0x${string}`;
    const icoAddress = (settingsData?.settings?.ico_contract || "0x300C8EEB80Af24FF831015cF667f670077Fe1564") as `0x${string}`;
        ...
        <div className="space-y-10 animate-in fade-in duration-200 relative">
            ...
            <div className="flex items-center justify-between">
                <button
                    ...
                    className="bg-[#212E73] hover:bg-[#1a255c] text-white px-8 py-3 rounded-full flex items-center gap-2 font-bold text-xs uppercase tracking-widest transition-all shadow-md hover:scale-105 active:scale-95 cursor-pointer"
                >
            ...
            <div className="space-y-6">
                <h3 className="text-zinc-900 font-bold text-lg px-2">Active Phases</h3>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-[#212E73] text-white">
                                    ...
                                    <th className="px-10 py-6 text-center text-xs font-bold uppercase tracking-widest">Status</th>
                                    <th className="px-12 py-6 text-center text-xs font-bold uppercase tracking-widest rounded-tr-[32px]">Actions</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr key={sale.id} className="hover:bg-zinc-50/70 transition-colors group">
                                        ...
                                        <td className="px-10 py-6 text-center">
                                            <div className="flex flex-col">
                                                <span className="text-zinc-900 font-bold text-lg tracking-tighter">{formatDecimal(sale.token_quantity, 5)}</span>
                                                <span className="text-xs text-zinc-400 font-bold uppercase tracking-[0.1em] mt-0.5">Tokens</span>
                                            </div>
                                        </td>
                                        <td className="px-10 py-6 text-center">
                                            <div className="flex flex-col">
                                                <span className="text-[#212E73] font-bold text-lg tracking-tighter">{formatDecimal(sale.total_tokens_sold, 5)}</span>
                                                <span className="text-xs text-zinc-400 font-bold uppercase tracking-[0.1em] mt-0.5">Sold</span>
                                            </div>
                                        </td>
                                        <td className="px-10 py-6 text-center">
                                            <div className="flex flex-col">
                                                <span className="text-zinc-900 font-bold text-lg tracking-tighter">{formatDecimal(sale.available_tokens, 5)}</span>
                                            </div>
                                        </td>
                                        <td className="px-10 py-6 text-center">
                                            <span className={cn(
                                                "px-5 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest border transition-all",
                                        ...
                                        <td className="px-12 py-6">
                                            <div className="flex items-center justify-center gap-3">
                                                <button
                                                    ...
                                                    className="p-2.5 bg-white border border-zinc-200 text-zinc-600 hover:text-[#212E73] hover:border-[#212E73]/30 rounded-xl transition-all shadow-sm cursor-pointer"
                                                    title="View Details"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="p-2.5 bg-white border border-zinc-200 text-zinc-600 hover:text-blue-600 hover:border-blue-300 rounded-xl transition-all shadow-sm cursor-pointer"
                                                ...
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        sale.computed_status === 'active'
                                                            ? "border-zinc-200 text-zinc-300 cursor-not-allowed opacity-40"
                                                            : "border-zinc-200 text-zinc-500 hover:text-red-600 hover:border-red-200 cursor-pointer"
                                                    )}
            ...
            {(() => {
                ...
                return (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                        <div className="bg-white w-full max-w-4xl rounded-[40px] border border-zinc-200 overflow-hidden relative shadow-2xl">
                            {/* Modal Header */}
                            <div className="p-8 sm:p-10 flex items-center justify-between border-b border-zinc-200 bg-zinc-50/50">
                                <div className="flex items-center gap-4 min-w-0">
                                    <div className="w-1.5 h-10 bg-[#212E73] rounded-full shrink-0" />
                                    <h2 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 tracking-tight uppercase font-space-grotesk truncate">{activeSale.name}</h2>
                                </div>
                                <div className="flex items-center gap-4 shrink-0">
                                    <span className={cn(
                                        "px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest border",
                                        activeSale.computed_status === 'active' ? "bg-emerald-100 text-emerald-700 border-emerald-200" : "bg-zinc-100 text-zinc-500 border-zinc-200"
                                    )}>
                                        {activeSale.computed_status}
                                    </span>
                                    <button
                                        onClick={() => setSelectedSale(null)}
                                        className="w-10 h-10 rounded-full bg-zinc-100 border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-900 transition-all cursor-pointer"
                                    >
                                        <X className="w-5 h-5" />
                                    </button>
                                </div>
                            ...
                            <div className="px-8 sm:px-10 py-8 space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="bg-zinc-50 border border-zinc-200 rounded-[28px] p-8 space-y-6 flex flex-col justify-between overflow-hidden">
                                        <div className="flex items-center gap-3">
                                            <div className="p-2 bg-[#212E73]/10 rounded-lg text-[#212E73] border border-[#212E73]/20">
                                        ...
                                        <div className="space-y-1 min-w-0">
                                            ...
                                            <p className="text-2xl sm:text-3xl font-bold text-[#212E73] tracking-tight font-space-grotesk break-all">
                                    ...
                                    <div className="bg-zinc-50 border border-zinc-200 rounded-[28px] p-8 space-y-6 flex flex-col justify-between overflow-hidden">
                                        ...
                                        <div className="space-y-3 pt-2 border-t border-zinc-200">
                                            <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest">
                                                <span className="text-zinc-500">Sale Progress</span>
                                                <span className="text-zinc-900 font-bold">{progressPercent.toFixed(2)}%</span>
                                            </div>
                                            <div className="h-2 bg-zinc-200 rounded-full overflow-hidden">
                                                <div
                                                    className="h-full bg-[#212E73] transition-all duration-1000"
                                ...
                                <div className="bg-zinc-50 border border-zinc-200 rounded-[28px] p-8">
                                    <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-16">
                                        <div className="flex items-center gap-3 shrink-0">
                                            <div className="p-3 bg-[#212E73]/10 rounded-2xl text-[#212E73] border border-[#212E73]/20">
                                        ...
                                        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">Start Time</p>
                                                    <p className="text-sm font-bold text-zinc-900 tracking-tight">{formatDate(activeSale.start_at)}</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-4">
                                                <Clock className="w-5 h-5 text-zinc-400" />
                                                <div>
                                                    <p className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">End Time</p>
                                                    <p className="text-sm font-bold text-zinc-900 tracking-tight">{formatDate(activeSale.end_at)}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex justify-center pt-2">
                                    <button
                                        onClick={() => setSelectedSale(null)}
                                        className="px-10 py-3 bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-zinc-700 rounded-full text-xs font-bold uppercase tracking-[0.2em] transition-all cursor-pointer shadow-sm"
                                    >
                                        Close Details
                                    </button>
                                </div>
            ...
            {editingSale && (() => {
                ...
                return (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                        <form onSubmit={handleUpdate} className="bg-white w-full max-w-sm rounded-[32px] border border-zinc-200 overflow-hidden shadow-2xl">
                            <div className="p-6 border-b border-zinc-200 bg-zinc-50/50 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <h2 className="text-xl font-bold text-zinc-900 tracking-tight">Edit Settings</h2>
                                    {isEnded && (
                                        <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest bg-zinc-100 text-zinc-600 border border-zinc-200">
                                            Ended
                                        </span>
                                    )}
                                </div>
                                <button type="button" onClick={() => setEditingSale(null)} className="text-zinc-400 hover:text-zinc-700 transition-colors cursor-pointer">
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                            <div className="p-6 space-y-4">
                                <div className="space-y-1.5">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {availableIcoBalance !== null && !isEnded && (
                                            <span className="text-[9px] text-[#212E73] font-bold">
                                    ...
                                    <input
                                        ...
                                        className={cn(
                                            ...
                                            isEnded
                                                ...
                                                : "bg-zinc-50 border-zinc-200 focus:outline-none focus:border-[#212E73]"
                                        )}
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-2">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-sm font-medium text-zinc-600 px-1">{formatDate(editingSale.start_at)}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block text-right">End Date</label>
                                        <p className="text-sm font-medium text-zinc-600 px-1 text-right">{formatDate(editingSale.end_at)}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="p-6 bg-zinc-50/50 border-t border-zinc-200 flex flex-col gap-3">
                                <div className="flex gap-3">
                                    <button
                                        type="button"
                                        disabled={isUpdatingPhase || isDeletingPhase || isStoppingPhase}
                                        onClick={() => setEditingSale(null)}
                                        className="flex-1 px-4 py-3 bg-white border border-zinc-200 hover:bg-zinc-100 disabled:opacity-50 text-zinc-700 rounded-xl font-bold text-sm transition-colors cursor-pointer shadow-sm"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            isEnded
                                                ...
                                                : "bg-[#212E73] hover:bg-[#1a255c] disabled:opacity-50 text-white cursor-pointer shadow-sm"
                                        )}
                                ...
                                {(editingSale.computed_status === 'active' || editingSale.status === 'active') && (
                                    <button
                                        ...
                                        className="w-full py-3 bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 rounded-xl font-bold text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
                                        title="Force stop this live sale immediately"
                                    >
                                        {isStoppingPhase ? <Loader2 className="w-4 h-4 animate-spin" /> : <Square className="w-4 h-4 fill-red-600" />}
                                ...
                                <button
                                    ...
                                    className={cn(
                                        "w-full py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2",
                                        editingSale.computed_status === 'active'
                                            ? "bg-zinc-100 text-zinc-400 border border-zinc-200 cursor-not-allowed opacity-50"
                                            : "bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 cursor-pointer shadow-sm"
                                    )}
                    ...
                    <form onSubmit={handleCreatePhase} className="bg-white w-full max-w-2xl rounded-[40px] border border-zinc-200 overflow-hidden shadow-2xl overflow-y-auto max-h-[90vh] custom-scrollbar">
                        <div className="p-8 border-b border-zinc-200 flex items-center justify-between bg-zinc-50/50">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-2xl font-bold text-zinc-900 tracking-tight uppercase font-space-grotesk">Initialize New Phase</h2>
                            </div>
                            <button
                                type="button"
                                disabled={isCreatingPhase}
                                onClick={() => setIsNewPhaseOpen(false)}
                                className="w-10 h-10 rounded-full bg-zinc-100 border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-900 disabled:opacity-50 transition-all cursor-pointer"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">Phase Name</label>
                                <input
                                    type="text"
                                    required
                                    disabled={isCreatingPhase}
                                    ...
                                    className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl px-5 py-4 text-zinc-900 focus:border-[#212E73] focus:ring-1 focus:ring-[#212E73] outline-none disabled:opacity-50"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between px-1">
                                        <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Allocated Tokens</label>
                                    </div>
                                    <input
                                        type="number"
                                        step="any"
                                        ...
                                        className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl px-5 py-4 text-zinc-900 focus:border-[#212E73] focus:ring-1 focus:ring-[#212E73] outline-none disabled:opacity-50 font-mono"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">Min Purchase (Trustive)</label>
                                    <input
                                        type="number"
                                        step="any"
                                        required
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">Max Purchase (Trustive)</label>
                                    <input
                                        type="number"
                                        step="any"
                                        required
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">Start Date & Time</label>
                                    <div className="relative cursor-pointer" onClick={(e) => {
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl pl-5 pr-12 py-4 text-zinc-900 focus:border-[#212E73] outline-none disabled:opacity-50 cursor-pointer"
                                        />
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">End Date & Time</label>
                                    <div className="relative cursor-pointer" onClick={(e) => {
                                        const input = e.currentTarget.querySelector('input');
                                        if (input) { try { (input as any).showPicker(); } catch (_) { input.focus(); } }
                                    }}>
                        ...
                        <div className="p-8 bg-zinc-50/50 border-t border-zinc-200 flex gap-4">
                            <button
                                type="button"
                                disabled={isCreatingPhase}
                                onClick={() => setIsNewPhaseOpen(false)}
                                className="flex-1 px-8 py-4 bg-white border border-zinc-200 hover:bg-zinc-100 disabled:opacity-50 text-zinc-700 rounded-2xl font-bold text-xs uppercase tracking-[0.1em] transition-all cursor-pointer shadow-sm"
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                disabled={isCreatingPhase}
                                className="flex-1 px-8 py-4 bg-[#212E73] hover:bg-[#1a255c] disabled:opacity-50 text-white rounded-2xl font-bold text-xs uppercase tracking-[0.1em] transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                            >
