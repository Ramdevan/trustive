...
export default function VestingManagement() {
    ...
    }, [settingsData, localMultipleVesting]);
        ...
        <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 self-end lg:self-center">
                    ...
                    >
                        <TrendingUp className={cn("w-4 h-4 text-[#36A886]", syncing && "animate-bounce")} />
            ...
            {showCreate && (
                <div className="bg-[#ECE9EA] rounded-[32px] border border-zinc-200/90 p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] animate-in zoom-in-95 duration-200">
                    <div className="flex items-center gap-4 mb-8">
                        <div className="w-12 h-12 rounded-2xl bg-[#36A886]/10 border border-[#36A886]/20 flex items-center justify-center">
                            <Plus className="w-6 h-6 text-[#36A886]" />
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className={cn(
                                    ...
                                    duplicateBlocked ? "border-red-400 focus:border-red-500" : "border-zinc-200 focus:border-[#36A886]"
                                )}
                            />
                            {duplicateBlocked && (
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl px-6 py-4 text-zinc-900 focus:outline-none focus:border-[#36A886] transition-all font-bold placeholder:text-zinc-400"
                            />
                        </div>
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">
                                Cliff Period (Units) <span className="text-[#36A886] normal-case font-semibold">— each unit = 2 mins</span>
                            </label>
                            <input
                                type="number"
                                min="0"
                                ...
                                className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl px-6 py-4 text-zinc-900 focus:outline-none focus:border-[#36A886] transition-all font-bold placeholder:text-zinc-400"
                            />
                            {newVesting.cliff && <p className="text-[10px] text-[#36A886] font-semibold px-1">→ Total cliff: {Number(newVesting.cliff) * 2} minutes</p>}
                        </div>
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">
                                Vesting Duration (Units) <span className="text-[#36A886] normal-case font-semibold">— each unit = 2 mins</span>
                            </label>
                            <input
                                type="number"
                                min="1"
                                ...
                                className="w-full bg-zinc-50 border border-zinc-200 rounded-2xl px-6 py-4 text-zinc-900 focus:outline-none focus:border-[#36A886] transition-all font-bold placeholder:text-zinc-400"
                            />
                            {newVesting.duration && <p className="text-[10px] text-[#36A886] font-semibold px-1">→ Total vest: {Number(newVesting.duration) * 2} minutes</p>}
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-2 bg-zinc-100 p-1 rounded-2xl border border-zinc-200">
                    <button
                        ...
                        className={cn(
                            ...
                            activeTab === "growth" ? "bg-[#36A886] text-white shadow-sm" : "text-zinc-600 hover:text-zinc-900"
                        )}
                    >
                        Active Vesting
                    </button>
                    <button
                        ...
                        className={cn(
                            "px-6 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all cursor-pointer",
                            activeTab === "history" ? "bg-[#36A886] text-white shadow-sm" : "text-zinc-600 hover:text-zinc-900"
                        )}
                    >
                        Claim History
                    </button>
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="relative max-w-sm w-full">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-zinc-200 rounded-2xl pl-12 pr-6 py-3.5 outline-none text-zinc-900 text-xs font-bold transition-all placeholder:text-zinc-400 focus:border-[#36A886] shadow-sm"
                        />
                    </div>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse">
                            ...
                            <tbody className="divide-y divide-zinc-200 bg-[#ECE9EA]">
                                {loading ? (
                                    <tr><td colSpan={5} className="px-8 py-20 text-center"><div className="animate-spin h-8 w-8 border-t-2 border-[#36A886] mx-auto rounded-full" /></td></tr>
                                ) : filtered.length > 0 ? (
                                        ...
                                        <tr key={v.id} className="hover:bg-zinc-200/50 transition-colors group">
                                            ...
                                            <td className="px-10 py-6 text-center">
                                                <div className="flex flex-col items-center">
                                                    <span className="text-zinc-900 font-bold text-base group-hover:text-[#36A886] transition-colors">{v.username || (v.beneficiary ? shortenAddress(v.beneficiary) : '—')}</span>
                                                    {v.beneficiary && (
                                            ...
                                            <td className="px-12 py-6 text-center">
                                                <button
                                                    ...
                                                    className="text-[#36A886] font-bold text-xs uppercase tracking-widest hover:underline cursor-pointer"
                                                >
                                                    View
                                                </button>
                                            </td>
                ...
                {totalPages > 1 && (
                    <div className="flex items-center justify-center gap-2 mt-8">
                        <button
                            ...
                            className="p-2 rounded-xl bg-white border border-zinc-200 text-zinc-500 disabled:opacity-30 hover:text-[#36A886] transition-all cursor-pointer shadow-sm"
                        >
                        ...
                        {[...Array(totalPages)].map((_, i) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    currentPage === i + 1 ? "bg-[#36A886] text-white shadow-sm" : "bg-white border border-zinc-200 text-zinc-600 hover:text-zinc-900 shadow-sm"
                                )}
                            >
                                {i + 1}
                            </button>
