  ...
  return (
    <div className="rounded-2xl bg-[#ECE9EA] p-12 border border-zinc-200/90 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col items-center justify-center text-center gap-6 relative overflow-hidden group min-h-[calc(28rem)]">
      <div className="relative">
        <div className="w-16 h-16 bg-[#315EFB] rounded-full flex items-center justify-center shadow-lg shadow-[#315EFB]/20 text-white">
      ...
      <button className="mt-4 px-10 py-4 bg-[#315EFB] hover:bg-[#2548D0] text-white font-bold rounded-2xl transition-all shadow-xl shadow-[#315EFB]/20 active:scale-[0.98] text-[1.125rem] cursor-pointer relative z-10">
        Connect Wallet
      </button>
    </div>
  );
