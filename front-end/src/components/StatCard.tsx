...
const StatCard: React.FC<StatCardProps> = ({ title, value, icon }) => {
  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4 rounded-2xl bg-[#ECE9EA] p-5 sm:p-6 border border-zinc-200/90 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_6px_24px_rgba(0,0,0,0.06)] hover:border-[#315EFB]/30 transition-all overflow-hidden min-h-[140px] h-full">
      <div className="flex items-center gap-3 min-w-0">
        {icon && <div className="h-5 w-5 bg-[#315EFB] rounded-full flex-shrink-0" />}
