  ...
  return (
    <div className="rounded-3xl bg-[#ECE9EA] p-6 md:p-8 border border-zinc-200/90 shadow-[0_4px_20px_rgba(0,0,0,0.03)] space-y-8">
          ...
          {PAYMENT_METHODS.map(m => (
            <button
              ...
              className={`flex items-center justify-center gap-2 py-3.5 px-3 rounded-xl transition-all cursor-pointer border ${method === m
                ? 'bg-[#36A886] border-[#36A886] text-white font-bold shadow-md shadow-[#36A886]/20'
      ...
      <div className="space-y-3">
        ...
        {method === 'CARD' ? (
          <div className="bg-gradient-to-r from-[#36A886]/5 via-purple-500/5 to-[#7D00FF]/5 rounded-2xl border border-purple-200/60 p-4 space-y-3">
              ...
              <div className="flex items-center gap-1.5 text-[0.75rem]">
                ...
                <div className="inline-flex rounded-lg bg-white p-0.5 border border-zinc-200 shadow-xs">
                  <button
                    ...
                    className={`px-2.5 py-0.5 rounded-md text-[0.7rem] font-bold transition-all cursor-pointer ${moonpayTargetCrypto === 'bnb_bsc'
                  ...
                  <button
                    ...
                    className={`px-2.5 py-0.5 rounded-md text-[0.7rem] font-bold transition-all cursor-pointer ${moonpayTargetCrypto === 'usdt_bsc'
                      ? 'bg-[#36A886] text-white shadow-xs'
                      : 'text-zinc-900 hover:text-zinc-900'
                      }`}
                  >
              ...
              <div className="flex items-center gap-1.5">
                {[50, 100, 250, 500].map((preset) => (
                  <button
                    ...
                    className={`px-2.5 py-1 text-[0.75rem] font-bold rounded-lg border transition-all cursor-pointer ${amount === preset.toString()
                      ? 'bg-[#36A886] border-[#36A886] text-white'
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-2.5">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#36A886] animate-pulse"></div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#36A886] text-[0.75rem] font-bold uppercase tracking-wider px-2 py-0.5 bg-blue-50 rounded-lg border border-blue-200">
                      {method}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 bg-white p-1 rounded-lg border border-zinc-200 shadow-xs">
                  {[25, 50, 75, 100].map((p) => (
                    <button
                      ...
                      className="px-2.5 py-1 text-[0.7rem] font-bold text-zinc-900 hover:text-[#36A886] hover:bg-zinc-100 rounded-md transition-all cursor-pointer"
                    >
                      {p === 100 ? 'MAX' : `${p}%`}
                    </button>
                  ))}
        ...
        <div className="relative group">
          <input
            ...
            disabled={loading}
            className="w-full bg-white border border-zinc-200 rounded-2xl py-5 pl-6 pr-[9.5rem] text-[1.25rem] text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-[#36A886] focus:ring-2 focus:ring-[#36A886]/10 transition-all font-medium disabled:opacity-50"
          />
      ...
      <div className="space-y-2">
        ...
        <div className="relative group">
          <input
            ...
            readOnly
            className={`w-full bg-zinc-50 border rounded-2xl py-5 pl-6 pr-[9.5rem] text-[1.25rem] placeholder:text-zinc-400 focus:outline-none font-bold transition-colors ${isBelowMin || isAboveMax
          ...
          <div className="absolute min-w-[8rem] right-4 top-1/2 -translate-y-1/2 flex items-center justify-center gap-2 px-3 py-2 border-l border-zinc-200 pointer-events-none">
            {isCalculating ? (
              <LuLoader className="h-5 w-5 text-[#36A886] animate-spin" />
            ) : (
      ...
      <ConnectButton.Custom>
        {({ account: rbAccount, chain, openConnectModal, openChainModal, mounted: rbMounted }) => {
          ...
          if (!connected) {
            ...
            btnLabel = 'Processing...';
            btnClass = 'bg-[#36A886]/60 text-white opacity-75 cursor-not-allowed';
            isDisabled = true;
          } else if (!hasAmount) {
