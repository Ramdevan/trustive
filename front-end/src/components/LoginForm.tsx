        ...
        <div className="flex flex-col justify-center p-8 md:p-16 space-y-6 bg-[#ECE9EA] shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-zinc-200/90 rounded-[1.25rem]">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#36A886] hover:bg-[#36A886] text-white font-bold py-4 md:py-5 rounded-[0.75rem] transition-all shadow-xl shadow-[#36A886]/20 active:scale-[0.98] text-[1.125rem] md:text-[1.25rem] cursor-pointer disabled:opacity-50"
            >
