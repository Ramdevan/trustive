...
const ModalContent = ({ t, resolve, message }: { t: any; resolve: (val: boolean) => void; message: string }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 z-[9999] pointer-events-none">
      ...
      >
        {/* Visual Accent Bar */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-1 bg-[#315EFB] rounded-b-full opacity-50" />
        ...
        <div className="p-6 pt-2 flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-6 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] text-white bg-[#315EFB] hover:bg-[#2548D0] transition-all cursor-pointer shadow-[0_10px_20px_rgba(49,94,251,0.25)]"
          >
            Confirm
          </button>
        </div>
